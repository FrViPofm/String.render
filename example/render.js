  ...
  */
  ...
  function _F(n, f, c){
    ...
    if(f.match(/\w+:/)){
      ...
      if(_f(n[F])){o=n[F](A)} // method n.f(A)
      else if(_f(eval(F))){o=eval(F)(n,A)} // function f(n,A)
    }
    else if(_f(n[f])){o=n[f]()} // method n.f()
    else if (_f(eval(f))){o=eval(f)(n)} // function f(n)
    return o || '';
  }
  /* parse */
  function _P(t,c,n){
  ...
  function _V(t,c,m){
    ...
    while(a = A.shift()){ // pipe
      ...
      else if(!_f(o[a]) && !_u(o[a])){o = o[a];} // property
      else if(_f(o[a])){o = o[a]();} // method
      else if(_f(eval(a))){o=eval(a)(o);} // function
    }
    return o;
  }
  for(var i in N){
